  ...
  return (
    ...
    <div className="bg-gradient-to-r from-[#35B6B4] to-[#283671] rounded-xl w-full md:w-[1002px] h-[149px]">
      <div className="flex flex-col md:flex-row items-center gap-10 h-full p-6">
        ...
        <div className="md:w-3/5 flex-shrink-0 text-center md:text-left">
        ...
        <div className="w-[212px] h-[58px] bg-[#E5DD18] rounded-full flex items-center justify-center m-6">
...
<div className="flex gap-4">
  ...
  <div className="flex-1">
    ...
    <button
      type="button"
      className="block rounded-full w-full px-3 py-2 border border-gray-300  shadow-sm bg-transparent text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
    >
      Choose Image
    </button>
  </div>
