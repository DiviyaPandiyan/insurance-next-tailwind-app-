...
const FormsPage = () => {
    ...
    <>
      <div className="flex flex-col items-center justify-center ">
        <div className="max-w-4xl w-full bg-white">
          ...
          <h1 className="md:text-2xl text-4xl font-bold ml-4 mt-4 text-[#170F49] md:justify-between">
            Building Details
          </h1>
  ...
  <form>
    ...
    <div className="flex gap-80">
      <label
        htmlFor="email1"
        className="text-sm font-bold text-[#112211]"
      >
        Total Fee
      </label>
      <label
  ...
  <form className="space-y-6 w-full max-w-md">
    ...
    <div className="flex justify-center">
      ...
      <div className="flex items-center justify-start ml-60 mt-8">
...
<div className="max-w-4xl w-full bg-white">
          <Image
            ...
            width={100}
            height={100}
            className="w-auto h-auto object-cover ml-48"
          />
        </div>
